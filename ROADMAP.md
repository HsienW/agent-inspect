...
## Current — repository health and evidence UX (`6.16.1` → `6.18.x`)

**Current release on npm:** **6.16.1** (eighteen fixed-group public packages). Persisted schema **1.0**. Node.js **≥ 20**. **MIT**. Actively maintained.
