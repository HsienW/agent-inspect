...
trainStatus: active
currentChunk: 6.15-1
nextAction: Parent/cycle adapter conformance expansion (invariants + fixtures). Stop before publish if external pilots missing.
...
6.15-0 fidelity classes A–E RFC landed. N-5 reader APIs are 6.15-4+. Do not fabricate pilots.
