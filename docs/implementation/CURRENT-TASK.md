...
**6.14.0** (target patch **6.14.1** — public positioning / docs / discoverability only)

## Notes

Docs and presentation train only. No schema change, new package, runtime feature family, default-network change, fabricated pilots, or v7.
