...
branch: "main"
currentChunk: "6.17.6-release"
lastConfirmedCommit: "075dc87"
lastValidationLevel: "core-runtime-gate"
nextAction: "Merge Version Packages PR; Trusted Publishing publishes 6.17.6 and public-truth:sync updates README/docs"
pendingManualGate: "merge Version Packages PR for 6.17.6"
githubIssues:
...
remainingTrains:
  - "v6.17.6 security containment (release-pending — Version Packages / Trusted Publishing)"
