...
lastConfirmedCommit: "c046c96"
lastValidationLevel: "release readiness + honest PARTIAL external gates"
nextAction: "Await Version Packages → publish 6.12.0; then adoption checkpoint"
