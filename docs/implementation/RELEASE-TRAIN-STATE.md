...
lastConfirmedCommit: "fdb442d"
lastValidationLevel: "chunk-tests"
nextAction: "Full validation gate for 6.17.6; then separate release-readiness / Changeset authorization"
...
remainingTrains:
  - "v6.17.6 security containment (active — validation gate)"
