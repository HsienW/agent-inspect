...
branch: "main"
currentChunk: "6.11-1"
lastConfirmedCommit: "d994264"
lastValidationLevel: "mcp executable pending push"
nextAction: "Land 6.11-1; continue 6.11-2 Official SDK/protocol migration"
...
remainingTrains:
  - "v6.11.0 Local coding-agent debug loop (active; 6.11-1 in flight)"
...
- **6.11-1 review:** [reviews/V6.11.0-1-MCP-EXECUTABLE.md](./reviews/V6.11.0-1-MCP-EXECUTABLE.md)
