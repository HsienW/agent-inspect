...
lastConfirmedCommit: "aad50b2"
lastValidationLevel: "CI green on doctor fix; test:all build-order fix pushed"
nextAction: "Land 6.7.5-2 better-sqlite3; continue 6.7.5-3+"
