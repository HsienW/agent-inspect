/**
 * Experimental Vitest matchers for AgentInspect TraceFacts / TraceContract.
 *
...
export interface AgentInspectVitestMatchers<R = unknown> {
  toPassTraceContract(contract: TraceContractInput): R;
  toHaveRequiredTool(toolName: string): R;
}

export const agentInspectVitestMatchers = {
